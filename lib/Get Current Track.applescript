global artistName, songName, albumName, songDuration, currentPosition, musicapp, apiKey, songMetaFile, mypath
set metaToGrab to {"artistName", "songName", "albumName", "songDuration", "currentPosition", "songChanged"}
...
if isMusicPlaying() is true then
	...
	if didSongChange() is true then
		delay 1
		writeSongMeta({ "artistName" & "##" & artistName, "songName" & "##" & songName, "songDuration" & "##" & songDuration, "songChanged" & "##" & true})
